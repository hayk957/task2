const phoneCont = document.querySelector('#phone-numbers');
...
class Phone {
  ...
  create(arg) {
    ...
    this.el.classList = 'col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 element__wrapper';
